...
class BertEmbeddings(nn.Module):
    ...
    def __init__(self, 
        config, 
        is_tam=False # boolean flag to determine whether we add a task embedding
    ):
        super().__init__()
        ...
        # modification to embedding layer, to add task embeddings
        self.is_tam = is_tam
...
class BertModel(BertPreTrainedModel):
    ...
    def __init__(self, 
        ...
        self.embeddings = BertEmbeddings(config, is_tam=is_tam)
